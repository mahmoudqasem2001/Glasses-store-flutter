        ...
        appBar: AppBar(
          actions: [
            InkWell(
              onTap: () {
                setState(() {
                  if (DummyData.favProducts.contains(loadedProduct)) {
                    DummyData.favProducts.remove(loadedProduct);
                  } else {
                    DummyData.favProducts.add(loadedProduct);
                  }
                });
              },
              child: DecoratedBox(
                ...
                child: Padding(
                  ...
                  child: Icon(
                    DummyData.favProducts.contains(loadedProduct)
                        ? Icons.favorite
